        ...
        <div className="relative grid min-h-screen grid-cols-1 items-center">
          ...
          <div className="hidden lg:flex items-center justify-center absolute inset-0 pointer-events-none">
            ...
            <div className="absolute inset-0 rounded-3xl">
              ...
              {/* Oranye Shape - Top Right Curve */}
              <div className="absolute top-0 right-0 w-80 h-80 rounded-bl-[200px] bg-[#C87536] opacity-80"></div>
              
              {/* Mustard Shape - Right */}
              <div className="absolute top-1/3 -right-20 w-72 h-72 rounded-full bg-[#D29A2A] opacity-60"></div>
              
              {/* Peach Shape - Bottom */}
              <div className="absolute bottom-0 left-0 w-96 h-96 rounded-tr-[200px] bg-[#F4AD73] opacity-70"></div>
              
              {/* Peach Circle - Center Right */}
              <div className="absolute top-1/2 right-1/4 w-40 h-40 rounded-full bg-[#F4AD73] opacity-50"></div>
              
              {/* Lines/Patterns */}
              <div className="absolute bottom-20 left-10 w-64 h-64 opacity-10">
                <svg viewBox="0 0 200 200" className="w-full h-full text-[#4A1D0B]">
              ...
              {/* Leaves/Botanical Elements */}
              <div className="absolute bottom-32 left-12 text-[#6B3410] opacity-40 text-6xl">🍂</div>
              <div className="absolute top-24 left-1/4 text-[#8B5A2B] opacity-30 text-5xl">🌿</div>
            </div>
            
            {/* Content */}
            <div className="relative z-10 text-center max-w-sm"></div>
          </div>
