          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-lg text-[#5C3D28] leading-relaxed">
                Dimulai dari dapur kecil di desa, Getuk Gondok berkembang menjadi bisnis keluarga yang menjaga tradisi pembuatan getuk selama puluhan tahun.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative">
                <div className="relative rounded-3xl overflow-hidden aspect-square bg-gradient-to-br from-[#F5EBE0] to-[#FAF3E8] border border-[#5C3D28]/10 flex flex-col items-center justify-center text-[#5C3D28]">
                  <svg className="w-16 h-16 mb-4 opacity-30" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <span className="text-sm opacity-60">Foto Keluarga Pendiri</span>
                </div>
                {/* Decorative circles */}
              ...
              <div>
                <h3 className="font-['Playfair_Display'] text-2xl lg:text-3xl font-semibold text-[#3D2314] mb-6">
                  Awal Mula Getuk Gondok
                </h3>
                <p className="text-[#5C3D28] leading-relaxed mb-5">
                  Pada tahun 1985, Ibu Siti mulai membuat getuk di dapur rumahnya untuk dijual ke tetangga dan pasar desa. Dengan resep rahasia dari ibunya, getuk buatannya segera dikenal karena teksturnya yang lembut dan rasa manisnya yang pas.
                </p>
                <p className="text-[#5C3D28] leading-relaxed mb-8">
                  Nama "Gondok" terinspirasi dari bentuk unik getuk yang dibungkus dengan daun pisang, memberikan aroma alami yang khas. Dari dapur kecil itu, kini Getuk Gondok telah melayani ribuan pelanggan setia di seluruh Jawa Tengah.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#3D2314] mb-1">1985 — Awal Perjalanan</h4>
                      <p className="text-sm text-[#5C3D28]/80">Ibu Siti memulai usaha dari dapur rumah dengan resep turun-temurun.</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="relative">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#3D2314] mb-1">2000 — Perluasan Produksi</h4>
                      <p className="text-sm text-[#5C3D28]/80">Menjadi供应商 tetap untuk pasar tradisional di beberapa kota.</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="relative">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#3D2314] mb-1">2020 — Era Digital</h4>
                      <p className="text-sm text-[#5C3D28]/80">Meluncur online dan menjangkau pelanggan di seluruh Indonesia.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <h2 className="font-['Playfair_Display'] text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
                Dari Singkong ke Getuk Sempurna
              </h2>
              <p className="text-lg text-white/70 leading-relaxed">
                Setiap helai getuk dibuat dengan proses tradisional yang membutuhkan kesabaran dan keahlian, dimulai dari pemilihan singkong terbaik hingga pengemasan dengan penuh cinta.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-5 gap-12 items-start">
              ...
              <div className="lg:col-span-3">
                ...
                <p className="text-center text-sm text-white/50 mt-5 relative z-10">
                  Video: Proses Pembuatan Getuk Gondok — Durasi 3:45
                </p>
              </div>
              ...
              <div className="lg:col-span-2 space-y-4">
                {[
                  { num: "1", title: "Pemilihan Singkong", desc: "Kami memilih singkong terbaik dari petani lokal, yang telah matang sempurna dan dipilih secara manual untuk memastikan kualitas." },
                  { num: "2", title: "Perebusan & Pengukusan", desc: "Singkong dikukus hingga lembut dengan api sedang, menjaga tekstur dan nutrisi alami tetap terjaga." },
                  { num: "3", title: "Pengecilan & Pencampuran", desc: "Singkong yang sudah lembut dihaluskan dan dicampur dengan gula Jawa pilihan dan kelapa parut premium." },
                  { num: "4", title: "Pengepakan Tradisional", desc: "Getuk dibungkus dengan daun pisang segar yang memberikan aroma autentik dan menjaga kesegaran." },
                ].map((step, index) => (
