              ...
              <div className="lg:col-span-5">
                <div className="relative">
                  ...
                  <div className="relative rounded-3xl overflow-hidden aspect-[4/5] bg-gradient-to-br from-[#E8C547]/20 to-[#E86A17]/10 border border-[#5C3D28]/15">
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-[#5C3D28]/50">
                      <svg className="w-16 h-16 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                      </svg>
                      <span className="text-sm font-medium">Kisah Keluarga Pendiri</span>
                    </div>
